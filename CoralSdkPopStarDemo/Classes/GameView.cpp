...
bool CGameView::init()
{
    ...
    auto uiBack = MenuItemLabel::create(text, CC_CALLBACK_1(CGameView::BackToMenu, this));
    ...
    ParticleSnow * ps = ParticleSnow::create();
    ps->setSpeed(200.0f);
...
void CGameView::BackToMenu(Ref *sender)
{
    this->addChild(CGameOver::create());
}
